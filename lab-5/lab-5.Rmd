...
This lab will take a look at (1) regularized regression models and (2) their corresponding hyperparameter tuning for both **linear** and **logistic** regression. Regularized regression models are related to the linear and logistic regression models we saw in chapter 3 and 4 of ISLR, but they contain a regularization term.
