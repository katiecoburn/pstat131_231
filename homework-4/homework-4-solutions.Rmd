...
test <- list(log_fit, lda_fit, qda_fit)
save(test, file = "all_model_results.rda")
load("all_model_results.rda")
...
```{r}
log_fit_othername <- load("log_results.rda")
log_fit_results <- read_rds("log_results.rds")
